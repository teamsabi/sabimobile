...
public class materi extends AppCompatActivity {
    ...
    private List<item_mapel> mapelList; // Daftar data jadwal atau materi
    private MapelAdapter mapelAdapter; // Adapter untuk RecyclerView
...
//                        rvMateri.setAdapter(mapelAdapter);
//
